...
<head>
    ...
    <script defer src="<?= BASEURL ?>public/assets/js/fetch-movies.js?v=<?= time() ?>"></script>
    ...
    <main>
        <div id="content">
            <div id="welcome">
                ...
                <p id="introduction">AnnexBios Leidsche Rijn is gevestigd op Berlijnplein 101, 3541 CM Utrecht. Bekijk
                    de locatie op de kaart en ontdek de handige parkeermogelijkheden. De bioscoop is goed bereikbaar met
                    zowel de auto als het openbaar vervoer. Kaartjes koop je op deze website of aan de kassa.</p>
            ...
            <div id="location">
                <div id="locLeft">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2451.087836981029!2d5.067164277188931!3d52.09633297195333!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c66f909248f195%3A0x932a461dcd459ab9!2sBerlijnplein%20101%2C%20Utrecht!5e0!3m2!1sen!2snl!4v1725608716675!5m2!1sen!2snl"
                    ...
                    <div id="locationInfo">
                        ...
                        <div id="accessibility">
                            ...
                            <p>AnnexBios Leidsche Rijn is telefonisch bereikbaar tijdens openingstijden, meestal vanaf
                                een half uur voor de eerste film tot een half uur na de laatste voorstelling. Voor
                                actuele tijden en vragen kun je het beste de website raadplegen of direct contact
                                opnemen.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <form action="">
                            ...
                            <div id="movieFilterSelect">
                                ...
                                <div id="movieFilterSelectArrowBox">
                                    <img src="<?= BASEURL ?>public/assets/img/icons/angle-down-primary.png"
                                        id="movieFilterSelectArrow" alt="">
                                </div>
                        ...
                        <div class="parent">
                            <?php for ($i = 1; $i <= 12; $i++): ?>
                                <div class="mobox<?= $i ?>">
                                    ...
                                    <div class="info-rect ">
                                        <h3>Welkom in Jurassic World: Fallen Kingdom! Favoriete personages keren terug in
                                            dit 3D actie-spektakel.</h3>
                                    </div>
                                    <div class="info-rect">
